...
class TestPortfolio:
    ...
    def test_portfolio_initialization(self):
        ...
        for capital in test_capitals:
            ...
            assert portfolio.current_balance_usdt == capital
            assert len(portfolio.positions) == 0
            assert len(portfolio.closed_positions) == 0
            assert portfolio.total_trades == 0
            assert portfolio.total_profit_usdt == 0.0
    ...
    def test_position_size_calculation(self):
        ...
        for quality_score, expected_size_pct in test_cases:
            ...
            assert position_size <= portfolio.current_balance_usdt * 0.25  # Max %25
    ...
    def test_portfolio_performance_multiplier(self):
        ...
        portfolio.total_profit_usdt = 500.0
    ...
    async def test_sell_execution(self):
        ...
        assert abs(portfolio.total_profit_usdt - expected_profit) < 0.01
    ...
    def test_portfolio_performance_summary(self):
        ...
        required_fields = [
            ...
            'sharpe_ratio', 'max_drawdown_pct', 'current_balance_usdt',
